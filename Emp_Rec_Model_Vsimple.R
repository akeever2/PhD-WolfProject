...
win.data <- list("nsites"=nsites, "nyears"=nyears, "nregions"=nregions, "area"=area,
                 ...
                 "em.group"=em.group, "y.group"=y.group, "imm.p"=imm.p, "em.p"=em.p)
...
params <- c("P", "s", "var.proc", "var.group", "G.mean", "gamma.mean", "N.tot") 
